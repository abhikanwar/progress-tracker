...
import {
  completeCoachActionParamsSchema,
  completeCoachActionSchema,
  executeCoachActionParamsSchema,
  executeCoachActionSchema,
  undoCoachActionParamsSchema,
...
coachRouter.post(
  "/chat/actions/:proposalId/execute",
